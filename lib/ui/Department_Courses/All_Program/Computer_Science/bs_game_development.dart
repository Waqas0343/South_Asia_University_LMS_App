...
class BsGameDvelopment extends StatelessWidget {
  const BsGameDvelopment({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: MyColors.primaryColor,
        title: const Text("BS Game Development"),
      ),
