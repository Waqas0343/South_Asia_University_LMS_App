...
class BsIslamicBanking extends StatelessWidget {
  const BsIslamicBanking({Key? key}) : super(key: key);
                        ...
                        child: Row(
                          children: const [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Money Banking and Finance Management ',
                              ),
                            )
                          ],
                        ),
                        ...
                        child: Row(
                          children: const [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Inventory Anslysis and Protfolio Management',
                              ),
                            )
                          ],
                        ),
                        ...
                        child: Row(
                          children: const [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(
                                'Financial Reporting and Standard',
                              ),
                            )
                          ],
                        ),
